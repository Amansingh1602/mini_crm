...
export const CommunicationEvent = (mongoose.models.CommunicationEvent || mongoose.model<ICommunicationEvent>('CommunicationEvent', CommunicationEventSchema)) as mongoose.Model<ICommunicationEvent>;
